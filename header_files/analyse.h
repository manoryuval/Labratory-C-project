...
/* Structure representing a register and its associated information */
...
/* Structure representing a missing line and its associated information */
...
/*
Search token from the opcodes array and return the opcode name.
...
/*
Search token from the register array and return the register name.
@param token a word to search.
...
@param am_line the line number in the .am file where the label is missing.
*/
