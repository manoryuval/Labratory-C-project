...
#define MAX_MCROS 100 /* Maximum number of macros */
#define MAX_MCRO_BODY 2048/* Maximum length of a macro body */
#define MAX_NAME 81 /* Maximum length of a macro name */
